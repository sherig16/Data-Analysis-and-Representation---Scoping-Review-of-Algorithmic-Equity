...
The visualization was created using **Tableau Desktop**, based on extracted data from a scoping review following **PRISMA-ScR** and **Arksey & O’Malley** methodology.  
The visualizations in Tableau include:
- 📈 **Country of Publication**
- ⚖️ **Equity-related themes**: Algorithmic Equity, Data Diversity, Participatory and Inclusive Design  
- 🧠 **Data Sources**: Public, Private, Mixed
- 🧩 **Medical Speciality**

Excel was used for data aggregation and Tableau for representation 
